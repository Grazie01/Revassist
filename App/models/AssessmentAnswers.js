...
console.log('Resolved Question Path:', path.resolve('../../App/models/Question.js'));
console.log('Resolved StudentAssessment Path:', path.resolve('../../App/models/StudentAssessment.js'));
...
const { AssessmentQuestion } = require(path.resolve('./App/models/Question.js'));
const { StudentAssessment } = require(path.resolve('./App/models/StudentAssessment.js'));
